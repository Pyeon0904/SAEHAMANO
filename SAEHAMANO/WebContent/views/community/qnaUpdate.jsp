      ...
      <section id="section">
         <div id="conbox">
            ...
            <div style="position: relative;">
               ...
               <div
                  style="left: 145px; width: 450px; font-family: GmarketSansLight; bottom: 130px; font-size: 12pt; font-weight: bold; position: absolute;">
            ...
            <div style="position: relative;">
               ...
               <div
                  style="left: 1345px; width: 450px; font-family: GmarketSansLight; bottom: 130px; font-size: 12pt; font-weight: bold; position: absolute;">
               ...
               <form action="<%= request.getContextPath()%>/community/qna/update" method="POST">
                     ...
                     <h2>
                        ...
                        <table id='tbl-board'>
                           ...
                           <tr>
                              <th colspan="2"><input style="font-family: GmarketSansLight;" type="submit" value="등록">
                                 <input style="font-family: GmarketSansLight;" type="reset" value="취소">
                                 <button type="button" id="btnDelete" style="color: #2a1b0a; font-family: GmarketSansLight; ">삭제</button> 
                                 </th>
                           </tr>
                        </table>
                        <!---------------------------------------------------------------------------------->
