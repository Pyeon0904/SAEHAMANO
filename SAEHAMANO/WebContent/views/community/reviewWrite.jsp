...
<link
	...
	rel="stylesheet">
<%
	//List<String> culture = (ArrayList)request.getAttribute("culture");
	//String[] cultureArr = culture.toArray(new String[culture.size()]);
	//String[] cultureArr = (String[])request.getAttribute("cultureArr");
	//System.out.println(cultureArr);
	String cultureString = (String)request.getAttribute("cultureString"); 
	System.out.println(cultureString);

	//String[] cultureArr = culture.toArray(new String[culture.size()]);
	//String cultureString = StringUtils.join(cultureArr,',');
	//for(String s : cultureArr){ System.out.println(s); }
%>
